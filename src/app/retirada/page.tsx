      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="flex flex-col justify-start items-center w-full p-4">
          <div className='flex flex-row justify-between items-center w-full h-10'>
            <h2 className="font-bold text-2xl w-full text-center">RETIRAR DO CAIXA</h2>
          </div>
          <form className="flex flex-col gap-6 w-96 justify-center p-2">
            <div className="flex flex-col gap-2 my-2">
              <label htmlFor="saldoini" className="font-semibold">Valor da retirada:</label>
              <Input
                id="saldoini"
                name="saldoini"
                type="text"
            ...
            <Button type='button' onClick={RetirarCaixa}>
              Reforçar Caixa
            </Button>
          </form>
        </div>
